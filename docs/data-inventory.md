...
| 서울시 유흥주점영업 인허가 정보 | 소재지와 중부원점TM(EPSG:5174) 좌표 제공. 위경도 좌표는 미제공. 3일 전 자료 제공 | 불가 | TM 좌표를 행정동 경계와 공간조인하고 영업 중 상태만 `nightlife` 중간 CSV로 변환 |
| 서울시 단란주점영업 인허가 정보 | 소재지와 중부원점TM(EPSG:5174) 좌표 제공. 위경도 좌표는 미제공. 3일 전 자료 제공 | 불가 | TM 좌표를 행정동 경계와 공간조인하고 영업 중 상태만 `nightlife` 중간 CSV로 변환 |
